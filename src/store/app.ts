...
// import { showToast } from "pages/ui-lib";
import { showToast } from '@/pages/Home/ui-lib';
      ...
      async onUserInput(content) {
        ...
        requestChatStream(sendMessages, {
          ...
          onController(controller) {
            ...
            ControllerPool.addController(sessionIndex, botMessage.id ?? messageIndex, controller);
          },
